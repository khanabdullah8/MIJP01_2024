...
ArrayList<Bean> al = new ViewDAO().userViewReceivedMessage(uid); %>
     <!-- PRE LOADER -->
               ...
               <div class="row" style="">
                    <div class="col-md-6 col-sm-12">
                         ...
                         <form action="./LoginServlet" method="post" class="wow fadeInUp" id="contact-form" role="form" data-wow-delay="0.8s">
							...
							<th style="color: white; font-family: Times New Roman; padding: 20px;">Sender Name</th>
							<th style="color: white; font-family: Times New Roman; padding: 20px;">Key</th>
                            ...
                            <th style="color: white; font-family: Times New Roman; padding: 20px;"><%=b.getSid()%></th>
                            <th style="color: white; font-family: Times New Roman; padding: 20px;"><%=b.getSname()%></th>
                            <th style="color: white; font-family: Times New Roman; padding: 20px;"><%=b.getKey()%></th>
                            <th style="color: white; font-family: Times New Roman; padding: 20px;"><a href="./EnterKey_user.jsp?mid=<%=b.getUid() %>&key=<%=b.getKey() %>" style="color: red;"  onclick="onc();">View</a></th>
                            </tr>
                            <%} %>
                            </table>
                                  <%}else{ %>
                                  		<h2 style="color: white;">Received Messages are Not available</h2>
                                   <%} %>
                              </div>
                         </form>
                    </div>
