...
<body class="body">
<%ArrayList<Bean> al = new ViewDAO().adminViewAcceptedMessages(); %>
     <!-- PRE LOADER -->
                    ...
                    <div class="col-md-6 col-sm-12">
                         ...
                         <div class="col-md-12 col-sm-12">
                              <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
                                   <h2 style="color: white;">Accepted Messages</h2>
                         ...
                         <form action="./LoginServlet" method="post" class="wow fadeInUp" id="contact-form" role="form" data-wow-delay="0.8s">
							...
							<th style="color: yellow; font-family: Times New Roman; padding: 20px;">Sid</th>
							<th style="color: yellow; font-family: Times New Roman; padding: 20px;">Rid</th>
							<th style="color: yellow; font-family: Times New Roman; padding: 20px;">Sname</th>
							<th style="color: yellow; font-family: Times New Roman; padding: 20px;">Rname</th>
                            </tr>
                            <%for(Bean b:al){ %>
                            <tr>
                            ...
                            <%} %>
                                  ...
                                  <%}else{ %>
                                  		<h2 style="color: white;">Messages are Not available</h2>
                                   <%} %>
                              </div>
                         </form>
                    </div>
